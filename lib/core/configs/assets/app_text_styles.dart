...
class AppTextStyles {
  // 36
  static TextStyle s36Regular({Color? color}) =>
      TextStyle(fontSize: 36.sp, fontWeight: FontWeight.w400, color: color);
  static TextStyle s36Medium({Color? color}) =>
      TextStyle(fontSize: 36.sp, fontWeight: FontWeight.w500, color: color);
  static TextStyle s36SemiBold({Color? color}) =>
      TextStyle(fontSize: 36.sp, fontWeight: FontWeight.w600, color: color);
  static TextStyle s36Bold({Color? color}) =>
      TextStyle(fontSize: 36.sp, fontWeight: FontWeight.w700, color: color);

  // 32
  static TextStyle s32Regular({Color? color}) =>
      TextStyle(fontSize: 32.sp, fontWeight: FontWeight.w400, color: color);
  static TextStyle s32Medium({Color? color}) =>
      TextStyle(fontSize: 32.sp, fontWeight: FontWeight.w500, color: color);
  static TextStyle s32SemiBold({Color? color}) =>
      TextStyle(fontSize: 32.sp, fontWeight: FontWeight.w600, color: color);
  static TextStyle s32Bold({Color? color}) =>
      TextStyle(fontSize: 32.sp, fontWeight: FontWeight.w700, color: color);

  // 24
  static TextStyle s24Regular({Color? color}) =>
      TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w400, color: color);
  static TextStyle s24Medium({Color? color}) =>
      TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w500, color: color);
  static TextStyle s24SemiBold({Color? color}) =>
  ...
  // 20
  static TextStyle s20Regular({Color? color}) =>
      TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w400, color: color);
  static TextStyle s20Medium({Color? color}) =>
      TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w500, color: color);
  static TextStyle s20SemiBold({Color? color}) =>
