...
class KeywordActivityModel {
  ...
  factory KeywordActivityModel.fromJson(Map<String, dynamic> json) {
    return KeywordActivityModel(
      ...
      baseDaysOffset: json['base_days_offset'] as int,
      isFreeTime: json['is_free_time'] as bool,
      hourTime: json['hour_time'] as int,
      endHourTime: json['end_hour_time'] as int,
      timeDuration: json['time_duration'] as int,
