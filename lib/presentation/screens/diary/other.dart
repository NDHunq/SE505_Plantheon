...
class _otherWidgetState extends State<otherWidget> {
  ...
  void initState() {
    ...
    if (widget.activityToEdit != null) {
      ...
      // Map fields for OTHER type
      // description -> contentController (Nội dung)
      // note -> noteController (Ghi chú)

      if (activity.description != null) {
        contentController.text = activity.description!;
      }
      ...
      if (widget.initialDescription != null) {
        contentController.text = widget.initialDescription!;
      }
  ...
  void _applyInitialFormData() {
    ...
    setTextController(contentController, 'description');
